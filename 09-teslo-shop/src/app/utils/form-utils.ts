  ...
  static getTextError(errors: ValidationErrors) {
    for (const key of Object.keys(errors)) {
      switch (key) {
        ...
        case 'minlength':
          return `Mínimo de ${// biome-ignore lint/complexity/useLiteralKeys: <explanation>
            errors['minlength'].requiredLength} caracteres.`;

        case 'min':
          return `Valor mínimo de ${// biome-ignore lint/complexity/useLiteralKeys: <explanation>
            errors['min'].min}`;
